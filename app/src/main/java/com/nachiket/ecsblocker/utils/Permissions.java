...
public class Permissions {
    ...
    public static void notifyIfNotGranted(@NonNull Context context) {
        ...
        if (count > 0) {
            ...
            com.nachiket.ecsblocker.utils.Utils.showToast(context, message, duration);
        }
    }
    ...
    private static void notify(@NonNull Context context, @NonNull String permission) {
        ...
        if (info != null) {
            ...
            com.nachiket.ecsblocker.utils.Utils.showToast(context, message, Toast.LENGTH_SHORT);
        }
    }
