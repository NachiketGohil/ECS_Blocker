...
public class DialogBuilder {
    ...
    public DialogBuilder(@NonNull Context context) {
        ...
        this.listLayout = getView().findViewById(R.id.items_list);
    }
    ...
    public DialogBuilder setTitle(String title) {
        TextView titleView = getView().findViewById(R.id.dialog_title);
    ...
    public DialogBuilder addItem(int id, String title, Object tag, final View.OnClickListener listener) {
        ...
        if (listener != null) {
            ...
            com.nachiket.ecsblocker.utils.Utils.scaleViewOnTablet(context, imageView, R.dimen.iconScale);
