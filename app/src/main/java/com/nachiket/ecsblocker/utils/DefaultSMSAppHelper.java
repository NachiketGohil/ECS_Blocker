...
import com.nachiket.ecsblocker.receivers.SMSBroadcastReceiver;
...
public class DefaultSMSAppHelper {
    ...
    public static void askForDefaultAppChange(Fragment fragment, int requestCode) {
        ...
        if (isDefault(context)) {
            ...
            packageName = com.nachiket.ecsblocker.utils.Settings.getStringValue(context, com.nachiket.ecsblocker.utils.Settings.DEFAULT_SMS_APP_NATIVE_PACKAGE);
        } else {
            ...
            if (nativePackage != null) {
                com.nachiket.ecsblocker.utils.Settings.setStringValue(context, com.nachiket.ecsblocker.utils.Settings.DEFAULT_SMS_APP_NATIVE_PACKAGE, nativePackage);
            }
        }
