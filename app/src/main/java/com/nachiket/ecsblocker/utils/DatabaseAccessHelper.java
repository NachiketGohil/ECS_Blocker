...
public class DatabaseAccessHelper extends SQLiteOpenHelper {
    ...
    public static DatabaseAccessHelper getInstance(Context context) {
        if (sInstance == null) {
            synchronized (DatabaseAccessHelper.class) {
                if (sInstance == null) {
                    if (com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.WRITE_EXTERNAL_STORAGE)) {
    ...
    public static boolean isSQLiteFile(String fileName) {
        ...
        try {
            ...
            com.nachiket.ecsblocker.utils.Utils.close(reader);
        }
        return false;
    }
...
//----------------------------------------------------------------
    ...
    public int deleteJournalRecords(com.nachiket.ecsblocker.utils.IdentifiersContainer contactIds, @Nullable String filter) {
...
//----------------------------------------------------------------
    ...
    public int deleteContacts(int contactType, com.nachiket.ecsblocker.utils.IdentifiersContainer contactIds, @Nullable String filter) {
        if (contactIds.isEmpty()) return 0;
