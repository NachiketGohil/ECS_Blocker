...
import com.nachiket.ecsblocker.utils.DatabaseAccessHelper.Contact;
import com.nachiket.ecsblocker.utils.DatabaseAccessHelper.ContactNumber;
import com.nachiket.ecsblocker.utils.DatabaseAccessHelper.ContactSource;
...
public class ContactsAccessHelper {
    ...
    public static String getPermission(ContactSourceType sourceType) {
        switch (sourceType) {
            case FROM_CONTACTS:
                return com.nachiket.ecsblocker.utils.Permissions.READ_CONTACTS;
            case FROM_CALLS_LOG:
                return com.nachiket.ecsblocker.utils.Permissions.READ_CALL_LOG;
            case FROM_SMS_LIST:
                return com.nachiket.ecsblocker.utils.Permissions.READ_SMS;
            case FROM_BLACK_LIST:
            case FROM_WHITE_LIST:
                return com.nachiket.ecsblocker.utils.Permissions.WRITE_EXTERNAL_STORAGE;
        }
        return null;
    }
...
//-------------------------------------------------------------------------------------
    ...
    public Cursor getContacts(Context context, ContactSourceType sourceType, @Nullable String filter) {
        ...
        if (permission == null || !com.nachiket.ecsblocker.utils.Permissions.isGranted(context, permission)) {
            return null;
        }
        // return contacts
        switch (sourceType) {
            ...
            case FROM_BLACK_LIST: {
                com.nachiket.ecsblocker.utils.DatabaseAccessHelper db = com.nachiket.ecsblocker.utils.DatabaseAccessHelper.getInstance(context);
                if (db != null) {
                    return db.getContacts(com.nachiket.ecsblocker.utils.DatabaseAccessHelper.Contact.TYPE_BLACK_LIST, filter);
                }
            }
            case FROM_WHITE_LIST: {
                com.nachiket.ecsblocker.utils.DatabaseAccessHelper db = com.nachiket.ecsblocker.utils.DatabaseAccessHelper.getInstance(context);
                if (db != null) {
                    return db.getContacts(com.nachiket.ecsblocker.utils.DatabaseAccessHelper.Contact.TYPE_WHITE_LIST, filter);
                }
            }
        }
        return null;
...
//-------------------------------------------------------------------------------------
    ...
    public Contact getContact(Context context, String number) {
        if (!com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.READ_CONTACTS)) {
            return null;
        }
    ...
    public boolean containsNumberInSMSContent(Context context, @NonNull String number) {
        if (!com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.READ_SMS)) {
            return false;
        }
    ...
    public boolean deleteLastRecordFromCallLog(Context context, String number, long duration) {
        if (!com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.WRITE_CALL_LOG)) {
            return false;
        }
    ...
    private long getLastRecordIdFromCallLog(Context context, String number, long duration) {
        if (!com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.READ_CALL_LOG)) {
            return -1;
        }
    ...
    public SMSConversationWrapper getSMSConversations(Context context) {
        if (!com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.READ_SMS) ||
                !com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.READ_CONTACTS)) {
            return null;
        }
...
//--------------------------------------------------------------------------------
    ...
    public boolean setSMSMessagesReadByThreadId(Context context, int threadId) {
        if (!com.nachiket.ecsblocker.utils.Permissions.isGranted(context, com.nachiket.ecsblocker.utils.Permissions.WRITE_SMS)) {
            return false;
        }
