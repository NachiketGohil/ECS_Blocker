...
import com.nachiket.ecsblocker.adapters.ContactsCursorAdapter;
...
import com.nachiket.ecsblocker.utils.IdentifiersContainer;
...
public class ContactsFragment extends Fragment implements com.nachiket.ecsblocker.fragments.FragmentArguments {
...
//----------------------------------------------------
    ...
    private static class ContactsLoader extends CursorLoader {
        ...
        ContactsLoader(Context context, int contactType, String itemsFilter,
